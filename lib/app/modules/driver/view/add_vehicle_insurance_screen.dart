...
class AddVehicleInsuranceScreen extends StatefulWidget {
  final String userId;
  const AddVehicleInsuranceScreen({super.key, required this.userId});

  @override
  _AddVehicleInsuranceScreenState createState() => _AddVehicleInsuranceScreenState();
}

class _AddVehicleInsuranceScreenState extends State<AddVehicleInsuranceScreen> {
  File? imageFile;
  ...
  Future<void> _uploadDocument(BuildContext context) async {
    ...
    try {
      ...
      if (docLink != null) {
        await UpdateDriverDocument().updateInsurance(
          widget.userId,
          docLink,
        );
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Vehicle insurance document uploaded successfully!')),
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Add Vehicle Insurance"),
      ),
      body: Stack(
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Image.asset(
                    "assets/images/get_started/driver_insurence.png",
                    height: 150,
                    fit: BoxFit.cover,
                  ),
                ),
